  ...
  return (
    <div>
      ...
      {tab === 'Renewals' && <section className="panel data-panel renewals-table-panel">
        ...
        <div className="table-scroll" tabIndex={0} aria-label="Membership renewals table. Scroll to view all columns."><table className="data-table"><thead><tr><th>Organisation</th><th>Current level</th><th>Renewal date</th><th>Agreement</th><th>Invoice</th><th>Owner</th><th>Next action</th></tr></thead><tbody>{renewals.map((org) => {
