...
const roleViews: Record<UserRole, string[]> = {
  Administrator: ['dashboard','organisations','pipeline','memberships','pages','listings','events','content','inbox','insights','billing','agreements','tasks','settings'],
  'Membership manager': ['dashboard','organisations','pipeline','memberships','pages','listings','events','content','inbox','insights','agreements','tasks'],
  'Content editor': ['dashboard','organisations','pages','listings','events','content','inbox','insights','tasks'],
